...
class 하위클래스 extends 상위클래스{ //메소드와 멤버변수를 물려받음
	int value1=100;
	int value2=200;
	public 하위클래스() {
		super();
...
public class Example2 { 
	public static void main(String[] args) {
		...
		System.out.println(obj2.value1);//100 //만일 상위클래스와 하위클래스 멤버변수가 같으면 현재 클래스의 멤버변수가 우선순위를 갖는다.
		...
		obj2.showSuperValue(); //현재 인스턴스의 물려받은 메소드 호출
