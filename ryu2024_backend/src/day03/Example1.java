...
public class Example1 { //클래스 시작
	...
	public static void main(String[] args) { //main start
		...
		int num2 = 10;
		int value2;
		value2 = ++num2; //num2값이 1증가 한 후에 value2 변수에 대입한다.
		System.out.println(value2); //value2 = 11, num2 = 11
		value2 = num2++; //value2 변수에 기존 num2값이 먼저 대입한 후에 1증가한다.
		System.out.println(value2);//value2 = 11, num2 = 12
		value2 = --num2; 	//num2 값이 1감소한 후에 value2 변수에 대입한다.
		System.out.println(value2);//value2 = 11, num2 = 11
		value2 = num2--;//value2변수에 기존 num2 값이 먼저 대입한 후에 num2값이 1감소한다.
		...
		int lastScore2 = --gameScore;//변수앞에 ++가 있으므로 대입(=)보다 1증가가 우선이다.
		System.out.println(lastScore2);//150
		
		// *사칙연산의 우선순위에 따라 *곱하기 한 후 +더하기 -> 0
		...
		System.out.println(value);//false // () 소괄호를 사용한 이유는 가독성 높이기 위해서
		
		//[6]논리연산자, &&논리곱 : 모두 참이면 참, ||논리합 !부정  : 하나라도 참이면 참, !부정
		int num1 = 10;
		int i = 2;
		
		boolean value3 = ((num1 = num1 + 10)<10)&& ((i = i+2)<10);
						//여기서 false이므로, 뒤 조건은 볼 필요 없으므로 코드 실행되지 않는다.
