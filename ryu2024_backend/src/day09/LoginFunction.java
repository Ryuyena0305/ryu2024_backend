...
public class LoginFunction {
	...
	UserInfo[] userInfoArray = new UserInfo[100];
	...
	void userInfoLogin(UserInfo[] userInfos) {
		...
		for (int index = 0; index <= userInfos.length - 1; index++) {
			if (userInfos[index].id != null && userInfos[index].id.equals(checkId) && userInfos[index].pw != null
					&& userInfos[index].pw.equals(checkPw)) {
